...
class FragmentBebidas : Fragment(), OnCheckedChangeListener  {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_menu_category3, container, false)
    ...
    private fun getListaDePratos(): List<Prato> {
        ...
        return listOf(
            ...
            Prato("Prato Teste 7", 25.00, "20 minutos"),
            Prato("Prato Teste 8", 25.00, "20 minutos"),
